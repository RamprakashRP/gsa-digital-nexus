...
// Import the Hyperspeed background component
import Hyperspeed from './components/Hyperspeed';

function App() {
  // Define the effect options for Hyperspeed, aligned with your dark theme
  // Using a preset as a base, then customising colors for Google Dark theme feel
  const hyperspeedEffectOptions = {
    distortion: 'turbulentDistortion', // Example preset distortion type
    length: 400,
    roadWidth: 10,
    islandWidth: 2,
    lanesPerRoad: 4,
