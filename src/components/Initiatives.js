  ...
  return (
    <section id="initiatives">
      <div className="container">
        ...
        <p style={{ textAlign: 'center', marginBottom: '30px', fontSize: '1.1em' }}>As a Google Student Ambassador, I will implement innovative programs designed to empower students through practical, self-driven engagement with Google's transformative tools.</p>
        <div className="initiative-grid">
          <div className="initiative-card">
            ...
            <img src="[LINK TO INITIATIVE 1 MOCKUP IMAGE]" alt="Gemini AI Sprint Challenge Mockup" style={{ maxWidth: '100%', height: 'auto', marginTop: '15px', borderRadius: '5px' }} />
          </div>
          <div className="initiative-card">
            ...
            {/* Optional: Add a small image mock-up for this initiative */}
            <img src="[LINK TO INITIATIVE 2 MOCKUP IMAGE]" alt="Discovery Circles Mockup" style={{ maxWidth: '100%', height: 'auto', marginTop: '15px', borderRadius: '5px' }} />
          </div>
